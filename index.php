  ...
  <body>
    <?php
        ...
        switch ($url){
            ...
            case 'gal1': include('gal.php'); break;
            case 'gal2': include('gal.php'); break;
            case 'gal3': include('gal.php'); break;
            case 'gal4': include('gal.php'); break;
            case 'gal5': include('gal.php'); break;
            case 'gal6': include('gal.php'); break;
            case 'gal7': include('gal.php'); break;
            ...
            case 'rot7': include('roteiro.php'); break;
